...
FONT_PATH = os.environ.get("WORDMARK_FONT", r"C:\Windows\Fonts\arialbd.ttf")
FONT_INDEX = int(os.environ.get("WORDMARK_FONT_INDEX", 0))   # face within a .ttf
...
TEXT = os.environ.get("WORDMARK_TEXT", "SUJAY")
...
def emit(frames, mode, out, dur, reveal):
    ...
    p.append(f'<text x="{canvas_w/2:.0f}" y="{TITLEBAR_H/2 + 4:.0f}" fill="{TITLE_TEXT}" '
             f'font-size="11.5" text-anchor="middle">sujay@github: ~$ ./wordmark.sh --3d</text>')
